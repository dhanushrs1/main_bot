...
# Add this with your other channel configurations
DUMP_CHANNEL = environ.get('DUMP_CHANNEL', None)
if DUMP_CHANNEL:
    try:
        DUMP_CHANNEL = int(DUMP_CHANNEL)
    except ValueError:
        logger.error('DUMP_CHANNEL ID is not a valid integer. Feature will be disabled.')
        DUMP_CHANNEL = None
